...
namespace DTO.Migrations
{
    ...
    [Migration("20210630014010_create-database")]
            ...
            modelBuilder.Entity("DTO.Model.Feedback", b =>
                {
                    ...
                    b.Property<int?>("ProductDetail_ID1")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DTO.Model.Product", b =>
                {
                    ...
                    b.Property<int?>("ProductState_ID1")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DTO.Model.Feedback", b =>
                {
                    ...
                    b.HasOne("DTO.Model.ProductDetail", "ProductDetail")
                        .WithMany("Feedbacks")
                        .HasForeignKey("ProductDetail_ID1");
            ...
            modelBuilder.Entity("DTO.Model.Product", b =>
                {
                    ...
                    b.HasOne("DTO.Model.ProductState", "ProductState")
                        .WithMany("Products")
                        .HasForeignKey("ProductState_ID1");
